                    ...
                    <tr>
                      ...
                      <td align="center" valign="top">
                          <logic:present name="Papa" >
        					<table border="1" width="180" align="center" cellspacing="0" bordercolor="#000000" bordercolorlight="#000000" bordercolordark="#000000">
		        			<tr>
				        	  <td align="center" bgcolor="#F0AF1C" colspan="2">
						        	<font color="#000000" size="1" >
							        <bean:write name="Papa" property="nombre"/>&nbsp;<bean:message key="monjes.abadia.nomciudad"/>&nbsp;<bean:write name="Papa" property="primerApellido"/>
						        </font>
					        </td>
        					</tr>
		        			<tr>
                              <td align="center">
                                  <img src="images/iconos/monje_papa.gif">
                              </td>
				        	  <td bgcolor="#E4CFA2" align="center">
                                                <table width="100%" border="0">
                                              <tr>
                                                <td align="right"><font color="#000000" size="1"><bean:message key="monjes.abadia.edad"/></font></td>
                                                <td><font color="#000000" size="1"><bean:write name="Papa" property="edad"/></font></td>
                                              </tr>
                                              <tr>
                                                <td align="right"><font color="#000000" size="1"><bean:message key="monjes.abadia.salud"/></font></td>
                                                <td><bean:write name="Papa" property="barra_salud" filter="false"/></td>
                                              </tr>
                                              <tr>
                                                <td align="right"><font color="#000000" size="1"><bean:message key="monjes.abadia.fe"/></font></td>
                                                <td><bean:write name="Papa" property="barra_fe" filter="false"/></td>
                                              </tr>
                                              <tr>
                                                <td align="right"><font color="#000000" size="1"><bean:message key="monjes.abadia.popularidad"/></font></td>
					...
					<tr>
					  <td bgcolor="#E4CFA2" colspan="2">
  						   ...
  						   <font color="#000000" size="1"><bean:message key="diplomacia.satisfaccion"/></font>
                                              ...
                                              <tr>
                                                <td align="left">
                                                  <html:link action="/popularidadMonje?voto=1" paramId="clave" paramName="Papa" paramProperty="idDeMonje">
                                                     <html:img border="0" src="images/iconos/16/marca.gif" altKey="diplomacia.satisfaccion.si" />
                                                  </html:link>
                                                </td>
                                                <td align="right">
                                                  <html:link action="/popularidadMonje?voto=0" paramId="clave" paramName="Papa" paramProperty="idDeMonje">
	                                              <html:img border="0" src="images/iconos/16/marca_roja.gif" altKey="diplomacia.satisfaccion.no" />
        	                                  </html:link>
                                                </td>
                                              </tr>
                                            </table>
              ...
              <!-- Obispos de tú region -->
                  <table border="0" width="100%" cellspacing="4" >
					...
					<tr>
					  <td align="center" bgcolor="#F0AF1C" colspan="2">
							<font color="#000000" size="1" >
							<bean:write name="ObispoRegion" property="nombre"/>&nbsp;<bean:message key="monjes.abadia.nomciudad"/>&nbsp;<bean:write name="ObispoRegion" property="primerApellido"/>
						</font>
					  </td>
					</tr>
					<tr>
					  ...
					  <td bgcolor="#E4CFA2" align="center">
                                            <table width="100%" border="0">
                                              <tr>
                                                <td align="right"><font color="#000000" size="1"><bean:message key="monjes.abadia.edad"/></font></td>
                                                <td><font color="#000000" size="1"><bean:write name="ObispoRegion" property="edad"/></font></td>
                                              </tr>
                                              <tr>
                                                <td align="right"><font color="#000000" size="1"><bean:message key="monjes.abadia.salud"/></font></td>
                                              ...
                                              <tr>
                                                <td align="right"><font color="#000000" size="1"><bean:message key="monjes.abadia.popularidad"/></font></td>
                                                <td><bean:write name="ObispoRegion" property="barra_popularidad" filter="false"/></td>
                                              </tr>
                                             </table>
					  </td>
					...
					<tr>
					  <td bgcolor="#E4CFA2" colspan="2">
                                            <table width="80%" border="0" align="center">
                                              <tr>
                                                <td align="left">
                                                  <html:link action="/popularidadMonje?voto=1" paramId="clave" paramName="ObispoRegion" paramProperty="idDeMonje">
                                                     <html:img border="0" src="images/iconos/16/marca.gif" altKey="diplomacia.satisfaccion.si" />
                                                  </html:link>
                                                </td>
                                                <td align="right">
                                                  <html:link action="/popularidadMonje?voto=0" paramId="clave" paramName="ObispoRegion" paramProperty="idDeMonje">
	                                              <html:img border="0" src="images/iconos/16/marca_roja.gif" altKey="diplomacia.satisfaccion.no" />
        	                                  </html:link>
                                                </td>
                                              </tr>
					...
					<tr>
                      ...
                      <td align="center">
                       <!-- Opciones -->
                       <logic:present name="ObispoRegion" >
	                       <table width="80%" border=1 cellspacing="0" bordercolor="#000000" bordercolorlight="#000000" bordercolordark="#000000">
        	                 <tr>
        	                 ...
        	                 <tr>
                	           <td align="right">
                                    ...
                                    <html:img src="images/iconos/16/ayuda.gif" altKey="diplomacia.jerarquia.comision.obispado.help"/>
                        	   </td>
                	           <td align="right">
                                     <bean:write name="ComisionRegion" property="cancelacion" />&nbsp;%
                                    <html:img src="images/iconos/16/ayuda.gif" altKey="diplomacia.jerarquia.comision.cancelacion.help"/>
                        	   </td>
                	           <td align="right">
                                     <bean:write name="ComisionRegion" property="venta5" />&nbsp;%
                                    <html:img src="images/iconos/16/ayuda.gif" altKey="diplomacia.jerarquia.comision.venta5.help"/>
                        	   </td>
                	           <td align="right">
                                     <bean:write name="ComisionRegion" property="venta10" />&nbsp;%
                                    <html:img src="images/iconos/16/ayuda.gif" altKey="diplomacia.jerarquia.comision.venta10.help"/>
                        	   </td>
                	           <td align="right">
                                     <bean:write name="ComisionRegion" property="venta15" />&nbsp;%
                                    <html:img src="images/iconos/16/ayuda.gif" altKey="diplomacia.jerarquia.comision.venta15.help"/>
                        	   </td>
                	           <td align="right">
                                     <bean:write name="ComisionRegion" property="transito" />&nbsp;%
                                    <html:img src="images/iconos/16/ayuda.gif" altKey="diplomacia.jerarquia.comision.transito.help"/>
                        	   </td>
