      ...
      <td vAlign="top" align="middle" width="100%">
        <html:form action="/papadoImpuestos">
          ...
          <table borderColor="#000000" cellSpacing="0" borderColorDark="#000000" width="100%" borderColorLight="#000000" border="1">
              <tr>
                <td align="middle" bgColor="#996633">
                  <p align="center"><b><font color="#ffffff"><bean:message key="diplomacia.jerarquia.comision.titulo1"/></font></b></p>
                </td>
              </tr>
              <tr>
                <td bgColor="#e4cfa2">
                  <table width="100%" border="0">
                      ...
                      <tr>
                        <td align="center"><html:text property="papado" name="PapadoImpuestos" size="4"></html:text>&nbsp;%
                        <html:img src="images/iconos/16/ayuda.gif" altKey="diplomacia.jerarquia.comision.papado.help"/>
                        </td>
                        <td align="center"><html:text property="cardenales" name="PapadoImpuestos" size="4"></html:text>&nbsp;%
                        <html:img src="images/iconos/16/ayuda.gif" altKey="diplomacia.jerarquia.comision.cardenales.help"/>
                        </td>
                      </tr>
                  </table>
                </td>
              ...
              <logic:equal name="Tab" value="0">
                  ...
                  <td align="center" bgcolor="#780A00">
                        <html:link action="/papadoImpuestos?tab=1">
		                    <font color="#FFFFFF"><b><bean:message key="obispado.impuestos.historia.titulo_regional"/></b></font>
                       </html:link>
                  </td>
              </logic:equal>
              <!-- Ficha 1-->
