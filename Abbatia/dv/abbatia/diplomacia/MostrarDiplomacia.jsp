    ...
    <table border="1" width="180" align="center" cellspacing="0" bordercolor="#000000" bordercolorlight="#000000"
        ...
        <tr>
            <td bgcolor="#E1C08B" align="center" colspan="2">
                <font color="#000000" size="1">
                    <html:link action="/mostrarMonje" paramId="clave" paramName="Abad" paramProperty="idDeMonje">
...
<td width="200" align="center" valign="top">
    ...
    <table border="1" width="180" align="center" cellspacing="0" bordercolor="#000000" bordercolorlight="#000000"
        ...
        <tr>
            <td colspan="2" bgcolor="#E1C08B" align="center">
                <font color="#000000" size="1">
                    <html:link action="/mostrarMonje" paramId="clave" paramName="Obispo" paramProperty="idDeMonje">
                        <bean:message key="monjes.abadia.masinfo"/>
                    </html:link>
                    <br>
...
<td width="200" align="center" valign="top">
    <table border="1" width="180" align="center" cellspacing="0" bordercolor="#000000" bordercolorlight="#000000"
        ...
        <tr>
            <td rowspan="2" align="center">
                <img src="images/iconos/monje_cardenal.gif">
            </td>
            <td bgcolor="#E4CFA2" align="center">
                <font color="#000000" size="1">
                    <bean:message key="monjes.abadia.edad"/>
        ...
        <tr>
            <td bgcolor="#E1C08B" align="center" colspan="2">
                <font color="#000000" size="1">
                    <html:link action="/mostrarMonje" paramId="clave" paramName="Cardenal" paramProperty="idDeMonje">
                        <bean:message key="monjes.abadia.masinfo"/>
                    </html:link>
                    <br>
...
<td width="200" align="center" valign="top">
    <table border="1" width="180" align="center" cellspacing="0" bordercolor="#000000" bordercolorlight="#000000"
        ...
        <tr>
            <td bgcolor="#E1C08B" align="center" colspan="2">
                <font color="#000000" size="1">
                    <html:link action="/mostrarMonje" paramId="clave" paramName="Papa" paramProperty="idDeMonje">
                        <bean:message key="monjes.abadia.masinfo"/>
                    </html:link>
                    <br>
                    <html:link action="/mostrar_produccion" paramId="clave" paramName="Papa" paramProperty="idDeMonje">
                        <html:img border="0" page="/images/iconos/16/ojo.gif" altKey="tooltip.produccion"/>
                    </html:link>
                </font>
            </td>
...
<td align="center">
    ...
    <table border="1" cellspacing="0" bordercolor="#000000" bordercolorlight="#000000" bordercolordark="#000000"
        ...
        <tr>
            ...
            <td class="menu" width="90" align="center" valign="bottom">
                <logic:equal value="0" name="Papa" property="estado">
                    <html:link action="/buscar_eminencias" paramId="monjeid" paramName="Papa" paramProperty="idDeMonje">
