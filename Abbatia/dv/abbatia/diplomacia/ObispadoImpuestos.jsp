          ...
          <table borderColor="#000000" cellSpacing="0" borderColorDark="#000000" width="100%" borderColorLight="#000000" border="1">
              <tr>
                <td align="middle" bgColor="#996633">
                  <p align="center"><b><font color="#ffffff"><bean:message key="obispado.impuestos.total.titulo"/></font></b></p>
                </td>
              </tr>
              <tr>
                <td bgColor="#e4cfa2">
      ...
      <td vAlign="top" align="middle" width="100%">
        <html:form action="/obispadoImpuestos">
          ...
          <table borderColor="#000000" cellSpacing="0" borderColorDark="#000000" width="100%" borderColorLight="#000000" border="1">
              <tr>
                <td align="middle" bgColor="#996633">
                  <p align="center"><b><font color="#ffffff"><bean:message key="diplomacia.jerarquia.comision.titulo"/></font></b></p>
                </td>
              </tr>
              <tr>
                <td bgColor="#e4cfa2">
                  <table width="100%" border="0">
                      ...
                      <tr>
                        <td align="center">
                            <html:text property="obispado" name="ObispadoImpuestos" size="4"></html:text>&nbsp;%
                            <html:img src="images/iconos/16/ayuda.gif" altKey="diplomacia.jerarquia.comision.obispado.help"/>
                        </td>
                        <td align="center">
                            <html:text property="cancelacion" name="ObispadoImpuestos" size="4"></html:text>&nbsp;%
                        ...
                        <td align="center">
                            <html:text property="transito" name="ObispadoImpuestos" size="4"></html:text>&nbsp;%
              ...
              <logic:equal name="Tab" value="0">
                  ...
                  <td align="center" bgcolor="#780A00">
                        <html:link action="/obispadoImpuestos?tab=1">
		                    <font color="#FFFFFF"><b><bean:message key="obispado.impuestos.historia.titulo_abadia"/></b></font>
                       </html:link>
                  </td>
                  <td align="center" bgcolor="#780A00">
                        <html:link action="/obispadoImpuestos?tab=2">
		                    <font color="#FFFFFF"><b><bean:message key="obispado.impuestos.historia.titulo_pago"/></b></font>
                       </html:link>
                  </td>
              </logic:equal>
              <!-- Ficha 1 -->
              <logic:equal name="Tab" value="1">
                  <td align="center"  bgcolor="#780A00">
                        <html:link action="/obispadoImpuestos?tab=0">
		                    <font color="#FFFFFF"><b><bean:message key="obispado.impuestos.historia.titulo"/></b></font>
                       </html:link>
                  </td>
