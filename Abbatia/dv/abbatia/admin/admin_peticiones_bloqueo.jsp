        ...
        <td bgcolor="#E4CFA2">
            <layout:pager maxPageItems="20" >
                <layout:collection name="BloqueosAbiertos" id="lista" >
                    ...
                    <layout:collectionItem title="peticion.bloqueo.lista.fecha.creacion" property="fechaCreacion" sortable="true"/>
                    <layout:collectionItem title="peticion.bloqueo.lista.abadia" property="nombreAbadia" sortable="true"/>
                    <layout:collectionItem title="peticion.bloqueo.lista.region" property="nombreRegion" sortable="true"/>
                    <layout:collectionItem title="peticion.bloqueo.lista.dias" property="diasBloqueo" sortable="true"/>
                    ...
                    <layout:collectionItem title="mensajes.inbox.table.seleccion">
                        <layout:link action="/AutorizarBloqueo" paramName="lista" paramId="idPeticion" paramProperty="peticionId" >
                          <layout:img border="0" page="/images/iconos/16/autorizar.jpg" altKey="tooltip.administracion.bloqueo.ok"/>
                        </layout:link>
                    </layout:collectionItem>
                    <layout:collectionItem title="mensajes.inbox.table.seleccion">
                        <layout:link action="/DenegarBloqueo" paramName="lista" paramId="idPeticion" paramProperty="peticionId" >
                          <layout:img border="0" page="/images/iconos/16/cancelar.jpg" altKey="tooltip.administracion.bloqueo.ko"/>
                        </layout:link>
                    </layout:collectionItem>
                </layout:collection>
            </layout:pager>
