        ...
        <td bgcolor="#E4CFA2">
            <layout:pager maxPageItems="8" >
                <layout:collection name="lista_abadias" id="lista" >
                    <layout:collectionItem title="peticion.bloqueo.busqueda.abadia.lista.nombre" property="nombre_abadia" sortable="true"/>
                    <layout:collectionItem title="peticion.bloqueo.busqueda.abadia.lista.region" property="nombre_region" sortable="true"/>
                    <layout:collectionItem>
                        <layout:link action="/ParametrosBloqueo" paramName="lista" paramId="idAbadia" paramProperty="idAbadia" >
                          <layout:img border="0" page="/images/iconos/16/autorizar.jpg" altKey="tooltip.peticion.bloqueo.seleccionar"/>
                        </layout:link>
                    </layout:collectionItem>
                </layout:collection>
            </layout:pager>
