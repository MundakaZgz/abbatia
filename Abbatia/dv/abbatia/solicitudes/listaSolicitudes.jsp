                    ...
                    <tr>
                      ...
                      <td align="center">
                       <logic:equal name="lista" property="voto" value="0" >
                         <logic:equal name="lista" property="estado" value="0" >
                          <html:link action="/solicitudSi" paramName="lista" paramId="solicitud" paramProperty="idSolicitud" >
                            <html:img border="0" page="/images/iconos/16/autorizar.gif" altKey="tooltip.autorizar"/>
                          </html:link>
                          <html:link action="/solicitudNo" paramName="lista" paramId="solicitud" paramProperty="idSolicitud" >
                            <html:img border="0" page="/images/iconos/16/denegar.gif" altKey="tooltip.denegar"/>
                          </html:link>
                          </logic:equal>
                       </logic:equal>
                       <logic:equal name="lista" property="voto" value="1" >
                        <html:img border="0" page="/images/iconos/16/autorizar.gif" altKey="tooltip.autorizada"/>
                       </logic:equal>
              ...
              <logic:iterate id="lista" name="solicitudes_propias" >
                <logic:equal name="lista" property="idTipoSolicitud" value="1" >
                    <tr>
                      ...
                      <td align="center">
                        <html:link action="/solicitudEliminar" paramName="lista" paramId="solicitud" paramProperty="idSolicitud" >
