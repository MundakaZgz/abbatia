              ...
              <table border="0" width="100%">
                <tr>
                  <td width="25%" align="center" colspan="2" >
                    <font size="3">
                     <b><bean:write name="VentaAgrupadaForm" property="descripcionFamilia"/></b>(<bean:write name="VentaAgrupadaForm" property="descripcionProducto"/>)
                    </font>
                  </td>
                </tr>
                <tr>
                  ...
                  <td width="25%" align="left">
                    <font size="3">
                      <html:text property="precio" size="7"/> (<bean:write name="VentaAgrupadaForm" property="precioMercado" />)
                    </font>
                  </td>
                </tr>
                <tr>
                  ...
                  <td align="center" >
                    <logic:equal value="true" name="VentaAgrupadaForm" property="usuarioNuevo" >
                        <html:checkbox property="venderACiudad" name="VentaAgrupadaForm" disabled="true" >
                            <bean:message key="mensaje.vender.venderaciudad" /> <bean:write property="precioVentaCiudad" name="VentaAgrupadaForm"/>
                        </html:checkbox>
                    </logic:equal>
