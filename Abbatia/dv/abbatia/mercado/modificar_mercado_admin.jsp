            ...
            <td bgcolor="#E4CFA2">
             ...
             <logic:equal value="1" name="usuario" scope="session" property="administrador" >
                ...
                <tr>
                  ...
                  <td>
                    <html:text maxlength="10" property="precioMinimo" name="datosMercadoAdmin" size="5"/>
                  </td>
                </tr>
                <tr>
                  <th>
                  ...
                  <td>
                    <html:text maxlength="10" property="precioMaximo"  name="datosMercadoAdmin" size="5"/>
                  </td>
                </tr>
              </logic:equal>
             ...
             <logic:notEqual value="1" name="usuario" scope="session" property="administrador" >
                <tr>
                  ...
                  <td>
                    <html:text maxlength="10" property="precioMinimoC" name="datosMercadoAdmin" size="5"/> >(<bean:write name="datosMercadoAdmin" property="precioMinimo" />)
                  </td>
                </tr>
                <tr>
                  <th>
                  ...
                  <td>
                    <html:text maxlength="10" property="precioMaximoC"  name="datosMercadoAdmin" size="5"/> <(<bean:write name="datosMercadoAdmin" property="precioMaximo" />)
                  </td>
                </tr>
              </logic:notEqual>
                <tr>
