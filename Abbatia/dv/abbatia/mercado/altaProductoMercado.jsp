                ...
                <tr>
                  ...
                  <td>
                    <html:select name="datosMercadoAdmin" property="claveAlimento">
                      <html:options collection="lista_alimentos" property="codigo" labelProperty="descripcion"/>
                    </html:select>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                     <html:select name="datosMercadoAdmin" property="claveAnimal">
                       <html:options collection="lista_animales" property="codigo" labelProperty="descripcion"/>
                     </html:select>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                     <html:select name="datosMercadoAdmin" property="claveRecurso">
                       <html:options collection="lista_recursos" property="codigo" labelProperty="descripcion"/>
                     </html:select>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                     <html:select name="datosMercadoAdmin" property="claveReliquia">
                       <html:options collection="lista_reliquias" property="codigo" labelProperty="descripcion"/>
                     </html:select>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                     <html:select name="datosMercadoAdmin" property="claveLibro">
                       <html:options collection="lista_libros" property="codigo" labelProperty="descripcion"/>
                     </html:select>
                  </td>
                </tr>
                <tr>
