              ...
              <table border="0" width="100%">
                <tr>
                  ...
                  <td width="25%" align="left">
                    <font size="3">
                     <b><bean:write name="VentaForm" property="descripcionFamilia"/></b>(<bean:write name="VentaForm" property="descripcionProducto"/>)
                    </font>
                  </td>
                </tr>
                <tr>
                  ...
                  <td align="center" colspan="2" >
                   <logic:equal value="true" name="VentaForm" property="usuarioNuevo" >
                        <html:checkbox property="venderACiudad" name="VentaForm" disabled="true" >
                            <bean:message key="mensaje.vender.venderaciudad" /> <bean:write property="precioVentaCiudad" name="VentaForm"/>
                        </html:checkbox>
                   </logic:equal>
