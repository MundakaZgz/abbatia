      ...
      <table border="1" width="50%" cellspacing="0" bordercolor="#000000" bordercolorlight="#000000" bordercolordark="#000000">
        ...
        <tr>
          <td align="center" bgcolor="#E4CFA2">
            <img border="0" SRC="images/libros/<bean:write name="libroDetalle" property="grafico"/>_<bean:write name="libroDetalle" property="nivel"/>.gif"/><br /><br >
             ...
             <tr>
               ...
               <td align="center" >
                 <logic:notEmpty name="lista" property="nombreMonje" >  
                    <bean:write property="nombreMonje" name="lista"/> <bean:message key="monjes.abadia.nomciudad"/> <bean:write property="apellidoMonje" name="lista"/>
                 </logic:notEmpty>
               ...
               <logic:equal name="lista" property="eliminable" value="1" >
                 <html:link action="/eliminarCopiaPeriodo" paramName="lista" paramProperty="claveLibroPeriodo" paramId="clave" >
                    <html:img border="0" page="/images/iconos/16/cancelar.jpg" altKey="tooltip.cancelarcopiaperiodo"/>
                 </html:link>
                </logic:equal>
                 <br/>
               </td>
