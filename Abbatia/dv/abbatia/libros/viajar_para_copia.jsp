          ...
          <tr height="20">
            <td align="center" bgcolor="#996633">
              ...
              <font color="#FFFFFF"  size="2">
                <bean:message key="viajar.confirmar.copiar.cabecera" /> <bean:write name="ViajarForm" property="nombreLibro" />
              </font>
              </b>
            </td>
          </tr>
              ...
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan="2" align="center" >
                    <table width="70%" border="1" bordercolor="#000000" bordercolorlight="#000000" bordercolordark="#000000">
                       <tr>
                         <td></td>
                ...
                <tr>
                  ...
                  <td>
                        <bean:write name="ViajarForm" property="precioCopia" /> <bean:message key="viajar.confirmar.monedas" />
                  </td>
                </tr>
               </table>
            </td>
