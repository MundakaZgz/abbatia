...
<html>
  ...
  <body bgcolor="#E1C08B">
    ...
    <html:form action="/actRegistro">
        ...
        <table width="64%" border="1" align="center" cellspacing="0" bordercolor="#000000" bordercolorlight="#000000" bordercolordark="#000000">
          <tr>
          ...
          <td colspan="2">
            <table border="0" align="center" bgcolor="#E4CFA2" width="100%">
              <tr>
                ...
                <td width="61%">
                  <html:text property="nombre" altKey="usuario.nombrealt" maxlength="10" name="RegistroForm" size="15"/>
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td>
                  <html:text maxlength="15" property="apellido1" alt="<bean:message key='usuario.apellido1alt'/>" name="RegistroForm" size="20"/>
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td>
                  <html:text maxlength="15" property="apellido2" alt="<bean:message key='usuario.apellido2alt'/>" name="RegistroForm" size="20"/>
                </td>
              </tr>
              <tr>
                <td>
