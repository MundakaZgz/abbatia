<%@ page import="java.util.*, java.text.*, org.abbatia.utils.Utilidades, org.abbatia.utils.AbadiaConfiguracion"%>
...
<bean:write name="Navega" filter="false"/>
 <br/>
              <!-- Mejores en Abbatia -->
              <table border="1" width="500" cellspacing="0" bordercolor="#000000" bordercolorlight="#000000" bordercolordark="#000000">
                <tr>
                  <td align="center" bgcolor="#000080"><font color="#FFFFFF" size="1" ><bean:message key="principal.portal.top.mejores" /></font></td>
                </tr>
                <tr>
                  <td bgcolor="#FFFFFF">
                      <font size="2" >
