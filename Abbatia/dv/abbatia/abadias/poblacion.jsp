  ...
  <body topmargin="2" leftmargin="2" bgcolor="#E1C08B" text="#000000">
    <p align="center">
      <logic:notEmpty name="DatosContents">
            <table border="1" width="200" cellspacing="0" bordercolor="#000000" bordercolorlight="#000000" bordercolordark="#000000">
              <tr>
                  ...
                  <table border="0" width="100%">
                    <tr>
                      <td width="50%" align="center">
                        <img border="0" src="images/iconos/16/aldeanos.gif" alt="<bean:message key="principal.aldeanos"/>"/>
                      </td>
