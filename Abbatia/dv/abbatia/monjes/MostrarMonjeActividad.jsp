	...
	<table width="100%" background="images/backgrounds/madera.jpg" cellSpacing="0" border="0">
	    ...
	    <td align="middle" width="5%">
	      <logic:notEqual name="ActividadesMonjeForm" property="anteriorID" value="0">
        	<html:link action="/mostrar_produccion" paramId="clave" paramName="ActividadesMonjeForm" paramProperty="anteriorID">
	    ...
	    <td align="middle" width="5%">
	      <logic:notEqual name="ActividadesMonjeForm" property="siguienteID" value="0">
	        <html:link action="/mostrar_produccion" paramId="clave" paramName="ActividadesMonjeForm" paramProperty="siguienteID">
        ...
        <table border="0">
            <tr>
              <td align="center" width="50" rowspan="5" valign="middle">
                <p align="center"><img src="/images/iconos/monje.gif"></td>
              <td align="right"><b><bean:message key="monjes.abadia.nombre"/></b></td>
              <td colspan="2">
                <bean:write name="ActividadesMonjeForm" property="nombre" filter="false"/>&nbsp;<bean:message key="monjes.abadia.nomciudad"/>&nbsp;
            ...
            <tr>
              ...
              <td colspan="2"><bean:write name="ActividadesMonjeForm" property="edad"/>&nbsp;<bean:message key="monjes.abadia.anyos"/></td>
            </tr>
            <tr>
