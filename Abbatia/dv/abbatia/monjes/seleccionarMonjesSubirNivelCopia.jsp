...
<html>
  ...
  <body bgcolor="#E1C08B">
    <center>
      <html:form action="/mostrarMonjesSubirNivelCopia" >
          ...
          <tr height="20">
            <td align="center" bgcolor="#996633">
              <b><font color="#FFFFFF"  size="2">
                  <bean:message key="edificios.abadia.biblioteca.seleccionmonje"/> <bean:write name="datosCopiaLibro" property="nombreLibro" />
                </font>
              </b>
              </td>
          </tr>
                  ...
                  <table border="1" width="100%" cellspacing="0" bordercolorlight="#808080" bordercolor="#808080" bordercolordark="#808080">
                    ...
                    <logic:notEmpty name="datosCopiaLibro" property="monjes" >
                      <logic:iterate id="lista" name="datosCopiaLibro" property="monjes">
                        <tr>
                          <td align="center">
                           <html:radio name="datosCopiaLibro" property="seleccion" idName="lista" value="idDeMonje" />
                          </td>
                          <td align="left">
                            <bean:write name="lista" property="nombre" /> <bean:message key="monjes.abadia.de" /> <bean:write name="lista" property="primerApellido" />
                          </td>
                          <td align="center">
