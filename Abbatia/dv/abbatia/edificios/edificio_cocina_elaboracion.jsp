...
<tr>
    <td align="center" colspan="4" bgcolor="#E4CFA2" style="border-top: none thin white;" >
    <html:form action="/elaborarAlimentos">
        <html:hidden property="accion" name="datosElaboracion" value="elaborar" />
        <bean:message key="edificios.abadia.cocina.elaboracion.seleccion"/>
        <html:select name="datosElaboracion" property="idProducto" onchange="elaborarAlimento(forms.datosElaboracion.idProducto.value);">
