                ...
                <table>
                    ...
                    <tbody>
                        <tr class="image">
                            <td>
                                <p class="textCenter">
                                    <img border="0" src="images/mapas/<bean:write name='Edificio' property='grafico_construccion'/>_1.gif" alt="<bean:write name='Edificio' property='nombre_edificio'/>"/> <br/> <br/>
                        ...
                        <tr class="content">
                            <td>
                                <dl>
                                    <dt><bean:message key="edificios.abadia.tiempocontruccion"/></dt><dd><bean:write name="Edificio" property="dias_costruccion"/> <bean:message key="edificios.abadia.dias"/></dd>
                                    <dt><bean:message key="edificios.abadia.costeoro"/></dt><dd><bean:write name="Edificio" property="coste_oro"/></dd>
                                    <dt><bean:message key="edificios.abadia.costemadera"/></dt><dd><bean:write name="Edificio" property="coste_madera"/></dd>
                                    <dt><bean:message key="edificios.abadia.costepiedra"/></dt><dd><bean:write name="Edificio" property="coste_piedra"/></dd>
                                    <dt><bean:message key="edificios.abadia.costehierro"/></dt><dd><bean:write name="Edificio" property="coste_hierro"/></dd>
                                </dl>
                            </td>
                        </tr>
                    </tbody>
                            ...
                            <td>
                                <logic:empty name="Abadiaid_Obispado">
                                    <logic:equal name="Edificio" property="existe" value="0" >
                                        <html:link action="/crear_edificio" paramId="clave" paramName="Edificio" paramProperty="tipo_edificio">
                                    ...
                                    <logic:equal name="Edificio" property="existe" value="1" >
                                        ...
                                        <logic:notEqual name="Edificio" property="siguienteNivel" value="0" >
                                            <br />
                                            <html:link action="/SubirNivel" paramId="clave" paramName="Edificio" paramProperty="edificioid">
                                                <b><bean:message key="edificios.abadia.subirnivel"/>&nbsp;<bean:write name="Edificio" property="siguienteNivel" /></b>
                                            </html:link>
                                        </logic:notEqual>
                                    </logic:equal>
                                </logic:empty>
