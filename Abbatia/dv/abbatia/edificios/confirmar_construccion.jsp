  ...
  <body topmargin="2" leftmargin="2" bgcolor="#E1C08B" text="#000000">
	...
	<logic:notEmpty name="Nombre">
 	...
 	<logic:notEmpty name="Abadiaid_Obispado">
		...
		<logic:notEmpty name="Nombre">
			<br /><bean:message key="edificios.construccion.confirmar.cabecera2"/>&nbsp;<bean:write name="Nombre" />
	        </logic:notEmpty>
              </font>
              </b>
            </td>
            ...
            <td bgcolor="#E4CFA2">
              <table border="0" width="100%">
                ...
                <tr>
                  ...
                  <td width="60%" align="left">
                    <font size="2">
                      <bean:write name="DatosEdificioForm" property="dias_costruccion"/> <bean:message key="edificios.abadia.dias" />
                    </font>
                  </td>
                </tr>
                <tr>
