        ...
        <tr>
          ...
          <td align="center">
            <logic:equal value="1" property="estado" name="lista">
              <a href="elaboracion_pausar.do?clave=<bean:write property="idElaboracion" name="lista" />" >
                <html:img border="0" page="/images/iconos/16/pausar.gif" altKey="tooltip.pausar"/>
              </a>
            </logic:equal>
            <logic:equal value="7" property="estado" name="lista">
              <a href="elaboracion_reanudar.do?clave=<bean:write property="idElaboracion" name="lista" />" >
