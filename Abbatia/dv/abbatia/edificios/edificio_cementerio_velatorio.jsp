...
<table border="1" width="90%" cellspacing="0">
    <tr>
        <td align="center" style="border-bottom: none thin white;border-right: none thin white;" bgcolor="#E4CFA2">
            <b><font size="2">
                <bean:message key="edificios.abadia.cementerio.tab.velatorio"/> ( <bean:write name="Edificio" property="numMonjesVelatorio" /> )
            </font>
            </b>
        </td>
        ...
        <td align="center" bgcolor="#780A00">
            <html:link action="/mostrarEdificio?Tab=osario" paramId="clave" paramName="Edificio" paramProperty="idDeEdificio">
                <font color="#FFFFFF">
