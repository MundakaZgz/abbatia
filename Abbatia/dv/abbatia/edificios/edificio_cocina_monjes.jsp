		  ...
		  <td>
					...
					<tr>
					  <td bgcolor="#E1C08B" align="center">
						<font color="#000000" size="1">
							<html:link action="/mostrarMonje.do" paramId="clave" paramName="Monje" paramProperty="idDeMonje">
								  <bean:message key="monjes.abadia.masinfo"/>
							</html:link><br>
				                        <html:link action="/mostrar_produccion.do" paramId="clave" paramName="Monje" paramProperty="idDeMonje">
