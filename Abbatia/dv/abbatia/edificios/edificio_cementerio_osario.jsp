...
<tr>
    <td align="center" bgcolor="#780A00">
        <html:link action="/mostrarEdificio?Tab=velatorio" paramId="clave" paramName="Edificio" paramProperty="idDeEdificio">
            <font color="#FFFFFF">
                <b><bean:message key="edificios.abadia.cementerio.tab.velatorio"/> ( <bean:write name="Edificio" property="numMonjesVelatorio" /> ) </b>
            </font>
        </html:link>
    </td>
    <td align="center" bgcolor="#780A00">
        <html:link action="/mostrarEdificio?Tab=cementerio" paramId="clave" paramName="Edificio" paramProperty="idDeEdificio">
            <font color="#FFFFFF">
                <b><bean:message key="edificios.abadia.cementerio.tab.cementerio"/> ( <bean:write name="Edificio" property="numMonjesCementerio" /> ) </b>
            </font>
        </html:link>
    </td>
    <td align="center" style="border-bottom: none thin white;border-right: none thin white;" bgcolor="#E4CFA2">
        <font size="2">
            <b><bean:message key="edificios.abadia.cementerio.tab.osario"/> ( <bean:write name="Edificio" property="numMonjesOsario" /> ) </b>
        </font>
    </td>
...
<logic:notEmpty name="Edificio" property="contenido">
    ...
    <table borderColor="#000000" width="90%" cellSpacing="0" align="center" borderColorDark="#000000" borderColorLight="#000000" border="0">
        <tr>
		<%
		    n = 0;
		%>
