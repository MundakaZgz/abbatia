...
<tr>
  ...
  <!--pestaña para salado de alimentos-->
  <td align="center" bgcolor="#780A00">
    <html:link action="/mostrarEdificio?Tab=salar" paramId="clave" paramName="Edificio" paramProperty="idDeEdificio">
    <b>
      <font color="#FFFFFF" size="2">
        <bean:message key="edificios.abadia.cocina.salar.titulo"/>
      </font>
    </b>
   </html:link>
  </td>
        ...
        <tr>
          ...
          <td align="center">
            <a href="javascript:venderAgrupado('<bean:write property="idAlimento" name="lista" />', 'A')" >
              <html:img border="0" page="/images/iconos/16/vender.jpg" altKey="tooltip.vender" titleKey="tooltip.vender"/>
            </a>
            <logic:greaterThan value="0" name="lista" property="idAlimentoSalado">
                <a href="salar_alimento.do?clave=<bean:write property="idAlimento" name="lista" />" >
                  <html:img border="0" page="/images/iconos/16/salar.gif" altKey="tooltip.salar" titleKey="tooltip.salar"/>
                </a>
            </logic:greaterThan>
            <br/>
          </td>
