                  ...
                  <b>
                    <font size="2">
                      ...
                      <logic:notEqual value="0" property="recurso_id" name="SacrificioForm" >
                        <br/>
                        <bean:message key="edificio.abadia.sacrificar.texto9" /> <bean:write name="SacrificioForm" property="recurso_min"/>
                        <bean:message key="edificio.abadia.sacrificar.texto10" /> <bean:write name="SacrificioForm" property="recurso_max"/> <bean:write name="SacrificioForm" property="unidad_recurso"/>
                        <bean:message key="edificio.abadia.sacrificar.texto11" /> <bean:write name="SacrificioForm" property="recurso_desc"/>
                      </logic:notEqual>
