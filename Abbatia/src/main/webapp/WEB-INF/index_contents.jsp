...
<logic:notPresent name="usuario" scope="session">
  ...
  <body onLoad="InicializarCrono();">
    <div id="container">
        <h3><bean:write property="nombre" name="abadia"/> (<bean:write property="ipActual" name="usuario" scope="session"/>)</h3>
        <div id="events">
            <h4><bean:message key="principal.portal.mensajesalertas"/></h4>
            <dl>
                <logic:iterate id="ultamens" name="DatosContents" property="ultMensajes">
                    <dt><bean:write property="fechaAbadia" name="ultamens"/></dt><dd><bean:write property="mensaje" name="ultamens" filter="false"/></dd>
                </logic:iterate>
            </dl>
	...
	<div class="floatLeft column">
		...
		<h5>
            <span class="monk">
                <a href="listarMonjes.do">
                      <u><bean:write name="DatosContents" property="contadorMonjes" filter="false"/> <bean:message key="principal.monjes"/></u>
                </a>
            </span>
        </h5>
		<ul>
        ...
        <p>
            <html:link action="/gestionGuardias?accion=inicio">
                <bean:write name="DatosContents" property="contadorGuardia" filter="false"/> <bean:message key="principal.guardias"/>
            </html:link>
        </p>
		<hr />
		...
		<p>
            <html:link action="/poblacion">
                <bean:write name="DatosContents" property="contadorAldeanos" filter="false"/> <bean:message key="principal.aldeanos"/>
            </html:link>
         </p>
	</div>          <!-- Monjes que requieren atenci&oacute;n -->
