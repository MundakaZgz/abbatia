...
/*
  ...
  public static int MONJES_VISITA_MIABADIA = 7;  // Monjes que est�n de visita en mi abbatia
  //public static int MONJES_VISITA_MIABADIA_ENF = 8;  // Monjes que est�n de visita en mi abbatia y estan enfermos
...
*/
    ...
    /**
     * Instancia la clase sin obtener una nueva conexi�n
     *
     * @param con Conexi�n
     * @throws AbadiaException Excepci�n general
     */
    ...
    /**
     * Devuelve la descripcion de la jerarqu�a eclesiastica de un monje
     *
     * @param idMonje
     * @param idIdioma
     * @return
    ...
    // Devuelve el n�m de monjes que hay vivos en una abbatia
    ...
    public ArrayList<MonjeProceso> recuperarMonjesMayores(int idAbadia, int iNumMonjes) throws AbadiaException {
        ...
        //consulta para verificar si la abad�a dispone de hospederia.
        if (oEdificioAD.existeEdificioTipo(idAbadia, Constantes.EDIFICIO_HOSPEDERIA)) {
            ...
            //si no dispone de hospeder�a, no se distingue entre eminencias y novicios...
    ...
    //dar� de alta un monje en la base de datos
     ...
     * - Insert en la tabla de monjes alimentaci�n
     * - Invocaciones a los m�todos de creaci�n de activicades y habilidades
     *
     * @param monje
     * @return
     * @throws AbadiaException
    ...
    */
    ...
    /**
     * Actualiza los datos de alimentaci�n de un monje
     *
     * @param monje
     * @return boolean
     * @throws AbadiaException
    ...
    */
    ...
    /**
     * Recupera toda la informacion relativa a un la locacizaci�n de un monje {@link MonjeVisita}
     *
     * @param idMonje  Identificador del monje
     * @param resource Objeto de recursos multiidioma
     * @return MonjeVisita
     * @throws AbadiaSQLException Excepci�n base de abbatia
     */
    public MonjeVisita recuperarLocalizacionMonje(int idMonje, MessageResources resource) throws AbadiaException {
        ...
        //si el monje est� de viaje hacia otra abad�a o est� de visita
        if (monje.getEstado() == Constantes.MONJE_VIAJE || monje.getEstado() == Constantes.MONJE_VISITA) {
            ...
            //si el monje est� en su abbatia, lo datos son los suyos propios
            monjeVisita = new MonjeVisita();
            monjeVisita.setIdMonje(monje.getIdMonje());
            monjeVisita.setIdAbadia(monje.getIdAbadia());
            monjeVisita.setIdRegion(monje.getIdRegion());
    ...
    public MonjeVisita recuperarDatosViaje(int idMonje) throws AbadiaException {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                //si la fecha partida origen no est� informada significa que est� de viaje hacia una abad�a o que ya ha llegado a la abad�a destino
    ...
    /**
     * Recupera un ArrayList con los monejs que llevan n d�as muertos
     *
     * @param nDias
     * @return
     * @throws AbadiaException
    ...
    public ArrayList<Monje> getMonjesParaCopiar(int idAbadia, MessageResources resource) throws AbadiaException {
        ...
        //no deber�an salir los monjes que ya tienen tar�as de copia.
    ...
    /**
     * Recupera un arraylist con los l�mites de salud por edades de los monjes
     *
     * @return
     * @throws AbadiaException
     */
    ...
    /**
     * Verifica si el tiempo transcurrido desde la �ltima expulsi�n autoriza una nueva
     *
     * @param idAbadia
     * @return
     * @throws AbadiaException
    ...
    /**
     * Recupera los puntos que aporta un monje al c�lculo general de la puntuaci�n
     *
     * @param idMonje
     * @return
     * @throws AbadiaException
    ...
    /**
     * recupera los datos del �ltimo monje expulsado a partir de una abad�a.
     *
     * @param idAbadia
     * @return
     * @throws AbadiaException
    ...
    /**
     * Recupera un arraylist de monjes que tienen alguna de sus tar�as sin asignar.
     *
     * @return
     * @throws AbadiaException
     */
