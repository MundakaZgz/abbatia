...
public class adUtils extends adbeans {
    ...
    */
    ...
    /*
          Metodo que devuelve una descripci�n de la Tabla directamente sin crear clases ni na!
          JOHN 05-05-2004
    */
    ...
    /*
          ...
          devuelve un string o un entero ( est� sobrecargado )
          JOHN 05-05-2004
    */
...
*/
    ...
    */
    ...
    /**
     * Recuperar un arraylist de integers a partir del sql recibido por par�metro
     *
     * @param sSQL
     * @return
     * @throws AbadiaException
    ...
    /*
          Funci�n que devuelve la propiedad, se sobrecarga el nombre de la propiedad por si lo sabes o no
          JOHN 05-05-2004
    */
    ...
    public ArrayList<Table> getCiudadesPorRegion(long region) throws AbadiaException {
        ...
        try {
            ...
            throw new AbadiaSQLException("Se ha producido un error buscando los nombre de ciudad para la regi�n.", e, log);
        } finally {
            DBMSUtils.cerrarObjetoSQL(rs);
            DBMSUtils.cerrarObjetoSQL(ps);
        }
    ...
    public InicioMain getInicioMain(String Param) throws AbadiaException {
        ...
        try {
            ...
            // Recuperar �ltimos acontecimientos
...
// ___________________________________________________________________________
    ...
    public HashMap<Integer, ArrayList<TableDouble>> generarHMActividad(String sSQL) throws AbadiaException {
        ...
        try {
            ...
            //nos aseguramos de cargar los datos de la �ltima abad�a procesada....
            hmResultado.put(idAbadiaTmp, alActividades);
            return hmResultado;
