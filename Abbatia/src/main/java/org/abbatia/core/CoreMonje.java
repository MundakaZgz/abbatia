...
public class CoreMonje extends adbeans {
    ...
    //este metodo crear� monjes para una abbatia cuando esta sea creada,
    //las propiedades de los monjes que se creen deberan ser determinadas
    //por los par�metros que el usuario determine en la abbatia.
    //es importante destacar que la creaci�n de estos monjes, no implicar�
    //su alta en la base de datos, ya que este alta se producir� solo
    //cuando el usuario acepte la composici�n ofrecida.
    ...
    public static String getNombreAleatorio(ArrayList<Table> TablaNombres) {
        if (TablaNombres == null || TablaNombres.isEmpty()) {
            // Evita excepciones en altas cuando faltan catálogos regionales en una instalación mínima.
            return "Frater";
        }
