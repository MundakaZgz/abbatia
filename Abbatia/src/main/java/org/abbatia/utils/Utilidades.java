...
public class Utilidades {
    ...
    //Metodo que a�ade ceros al incio de un String
    ...
    public static void check(String pass) throws AbadiaException {
        ...
        /* de momento no contralamos may�sculas y min�sculas...
            if (! upperCase)
        ...
        */
        if (!numeric)
            throw new pwdSinNumerosException("Utilidades.check. pwd sin N�meros", log);
