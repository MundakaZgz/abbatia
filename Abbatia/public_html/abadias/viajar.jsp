    ...
    <tr>
        <td bgcolor="#E4CFA2">
            <table border="0" width="100%">
                    ...
                    <td>
                        <html:select name="ViajarForm" property="tiempo">
                            <html:option value="2"><bean:message
                                    key="viajar.confirmar.tiempo.2dias"/></html:option>
                            <html:option value="7"><bean:message
                                    key="viajar.confirmar.tiempo.7dias"/></html:option>
                            <html:option value="15"><bean:message
                                    key="viajar.confirmar.tiempo.15dias"/></html:option>
                            <html:option value="30"><bean:message
                                    key="viajar.confirmar.tiempo.1mes"/></html:option>
                            <html:option value="0"><bean:message
                                    key="viajar.confirmar.tiempo.indefinido"/></html:option>
                        </html:select>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2">
                        <table width="100%" border="1" bordercolor="#000000" bordercolorlight="#000000"
                               bordercolordark="#000000">
                            <tr>
                                <td></td>
