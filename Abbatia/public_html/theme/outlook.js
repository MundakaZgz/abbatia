...
function b_writeStyle() {
  ...
  document.write('.button {width:300; text-align:center; font-family:tahoma,arial;');
  document.write(' font-size:10pt; cursor:hand; border-width:1;');
  document.write(' border-style:solid; border-color:white; ');
  document.write('background-color:#E1C08B;}');

  document.write('.noLine {text-decoration:none;}');

  document.write('.imgB {color:white; font-family:tahoma,arial; font-size:10pt;}');
...
var c=0;
  ...
  if (bt.ns4) {                 //draw OutlookBar for ns4
    ...
    for (i=0;i<this.panels.length;i++) {
      ...
      document.write('width=16 height=16 src=/images/iconos/16/arrowup.gif border=0>');
      ...
      document.write('src=/images/iconos/16/arrowdown.gif border=0></A></LAYER>');
    ...
    for (i=0;i<this.panels.length;i++) {
      ...
      document.write('onmouseOver="'+this.panels[i].v+'.clear();">');
      document.write('<img width=16 height=16 src=/images/iconos/16/arrowup.gif border=0>');
      ...
      document.write('onmouseOver="'+this.panels[i].v+'.clear();">');
      document.write('<img width=16 height=16 src=/images/iconos/16/arrowdown.gif border=0>');
      document.write('</A></DIV>');
...
function createOutlookBar(name,x,y,width,height,bgcolor,pagecolor) {
  ...
  this.buttonspace=90                     // distance of panel buttons
