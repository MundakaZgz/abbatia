        ...
        <div id="registroUsuario">
            ...
            <div class="floatRight" style="width:70%">
                ...
                <div class="row">
                    ...
                    <html:text styleClass="field" property="email" alt="Correo Electr�nico" maxlength="40"
                               name="RegistroForm"
                    ...
                    <%--
                                        ...
                                        <dd>
                                            <html:text property="email" alt="Correo Electr�nico" maxlength="40" name="RegistroForm"
                                                       size="40" styleId="email"/>
                                        </dd>
                    --%>
                <div class="row">
