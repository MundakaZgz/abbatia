...
<div id="container">
    <display:table name="requestScope.Edificio.contenido" uid="edificio_artesania" pagesize="10"
        ...
        <display:setProperty name="export.xsl.filename" value="edificio_artesania.xsl"/>
        <display:setProperty name="export.pdf.filename" value="edificio_artesania.pdf"/>
        <display:setProperty name="export.csv.filename" value="edificio_artesania.csv"/>
        ...
        <display:column titleKey="edificios.abadia.tabla.opciones">
            <a href="javascript:vender('${edificio_artesania.recursoID}', 'R');">
