    ...
    <display:column titleKey="edificios.abadia.tabla.opciones">
        <c:choose>
            <c:when test="${edificio_biblioteca_local.estado == 2}">
                ...
                <html:link action="/desmontarLibro" paramName="edificio_biblioteca_local"
                           paramProperty="idLibro"
                           paramId="clave"
                           onclick="return confirmarDesmontarLibro(${edificio_biblioteca_local.numPaginasCopiadas/2*30/100},${edificio_biblioteca_local.numPaginasCopiadas/2*80/100})">
                    <html:img border="0" page="/images/iconos/16/icon_scissors.gif"
                              altKey="tooltip.libro.desmontarlibro"/>
                </html:link>
