...
<div id="container">
    <display:table name="requestScope.Edificio.contenido" uid="edificio_almacen" pagesize="10"
        ...
        <display:column property="volumen" titleKey="edificios.abadia.almacen.volumen" sortable="true"
        ...
        <display:column titleKey="edificios.abadia.tabla.opciones">
            <a href="javascript:vender('${edificio_almacen.recursoID}', 'R');">
